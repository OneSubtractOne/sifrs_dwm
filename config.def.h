...
static const Rule rules[] = {
	...
	{ "ProtonMail Bridge",	NULL,	NULL,	1 << 7,		0,	-1 },
};
...
static const char *mediastop[] = { "vitunes", "-c", "media_stop", NULL };
static const char *mediapause[] = { "vitunes", "-c", "media_pause", NULL };
static const char *mediaplay[] = { "vitunes", "-c", "media_play", NULL };
...
static Key keys[] = {
	...
	{ 0,              XF86XK_AudioPause,       spawn,          {.v = mediapause } },
